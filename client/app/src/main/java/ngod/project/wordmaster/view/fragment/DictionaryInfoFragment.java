...
import ngod.project.wordmaster.databinding.FragmentDictionaryInfoBinding;
...
import ngod.project.wordmaster.view.dialog.bottomsheet.MyTestOptionBottomSheetDialog;
import ngod.project.wordmaster.view.dialog.custom.CreateWordDialog;
import ngod.project.wordmaster.view.dialog.custom.DictionaryUpdateDialog;
        ...
        requireActivity().getOnBackPressedDispatcher().addCallback(getViewLifecycleOwner(), new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                if (requireActivity() instanceof MainActivity) {
                    ...
                    ((MainActivity) requireActivity()).changeFragment(Const.DICTIONARY_FRAGMENT); // 원하는 프래그먼트 번호 넣기
                }
            }
        });
                    ...
                    public void setOnClickUpdateButton() {
                        ...
                        dialog.setOnClickListener(new CreateWordDialog.OnClickListener() {
                            ...
                            public void onSubmitClick(String eng, String kor, int mode) {
                                ...
                                Log.e(TAG,spUserId+","+roomKey+"list"+item.getRoomKey()+" "+item.getRoomKey());
